...
from cc_collab.web.webhook import (
...
class TestSendWebhook:
    ...
    async def test_send_success(self):
        ...
        with patch("cc_collab.web.webhook.httpx.AsyncClient") as mock_cls:
