...
from cc_collab.web.sse import sse_manager
...
def _run_implement_stage(
    ...
    from cc_collab.bridge import run_implement
...
async def start_pipeline(body: PipelineRunRequest):
    ...
    from cc_collab.web.db import get_db
    from cc_collab.web.models import PipelineRun, insert_pipeline_run
...
async def cancel_pipeline(work_id: str):
    ...
    from cc_collab.web.db import get_db
    from cc_collab.web.models import update_pipeline_run_status
